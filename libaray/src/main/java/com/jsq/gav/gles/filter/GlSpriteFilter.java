...
public class GlSpriteFilter extends GlFilter {
    ...
    public GlSpriteFilter(Context context) {
        super(context);
        createCoordsBuffer();
    }
    ...
    protected void createCoordsBuffer(){
        ...
        mTexCoordsVertices = GlUtil.createFloatBuffer(GlConstants.UV_COORDS_ROTATION_90);
    }
