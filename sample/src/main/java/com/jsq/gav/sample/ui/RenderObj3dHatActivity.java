...
public class RenderObj3dHatActivity extends BaseActivity {


    public static void start(Context context) {
        Intent starter = new Intent(context, RenderObj3dHatActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            mGLSurfaceView.setRenderer(new ObjRender(this, ObjModel.read(getAssets().open("hat/hat.obj"))));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    class ObjRender implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            mProgramHandle = GlUtil.createProgram(loadShaderFormAssets("hat/obj.vert"), loadShaderFormAssets("hat/obj.frag"));
